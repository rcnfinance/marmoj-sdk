...
public class SampleKeys {
    ...
    public static final String ADDRESS_NO_PREFIX = cleanHexPrefix(ADDRESS);

    public static final String PASSWORD = "Insecure Pa55w0rd";

    static final BigInteger PRIVATE_KEY = toBigInt(PRIVATE_KEY_STRING);
    static final BigInteger PUBLIC_KEY = toBigInt(PUBLIC_KEY_STRING);
